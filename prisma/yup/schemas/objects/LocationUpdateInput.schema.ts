...
NullableFloatFieldUpdateOperationsInputObjectSchema]),  arena: ArenaUpdateManyWithoutLocationNestedInputObjectSchema,  personalDetails: PersonalDetailsUpdateOneWithoutLocationNestedInputObjectSchema
});
