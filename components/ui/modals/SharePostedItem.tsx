...
const connector = connect((state: RootState, props: any) => ({
    open: state.UI.modals.shareItem,
    props: props
}))
...
const ShareItemModal = connector(({ open }: ShareItemModalProps) => {

    const closeModal = () => {
        store.dispatch(hideModal("shareItem"))
    }

    return (
        <div
            className={clsx("fixed inset-0 z-10 overflow-y-auto scale-0 opacity-0 transition-all duration-300 ease-out", open && "scale-100 opacity-100")}
            ...
            <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div className="relative inline-block p-4 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl sm:max-w-sm rounded-xl dark:bg-gray-900 sm:my-8 sm:w-full sm:p-6">
                    <div className="flex items-center justify-center mx-auto">
                        <Image className="h-full rounded-lg" src="https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" />
                    </div>
                    ...
                    <div className="mt-5 text-center">
                        ...
                        <p className="mt-2 text-gray-500 dark:text-gray-400">
                            This item has been published. Potential buyers will now be able to view this post.
                        </p>
                    </div>
...
ShareItemModal.displayName = "ShareItemModal"
